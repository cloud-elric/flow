...
/**
 * MunicipiosController implements the CRUD actions for CatMunicipios model.
 */
class MunicipiosController extends Controller
{
    ...
    // Obtiene el municipio a partir de una colonia
    public function actionGetMunicipioByColonia($colonia=null){
        \Yii::$app->response->format = Response::FORMAT_JSON;
        $respuesta ['status'] = "error";

        $colonia = CatColonias::findOne($colonia);
        $municipio = $colonia->idMunicipio;
    ...
    {
        if (($model = CatMunicipios::findOne($id)) !== null) {
            return $model;
        } else {
