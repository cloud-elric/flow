...
/**
 * EntEquiposSearch represents the model behind the search form about `app\models\CatEquipos`.
 */
class EntEquiposSearch extends CatEquipos
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_equipo', 'b_habilitado'], 'integer'],
