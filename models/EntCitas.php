...
class EntCitas extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'txt_descripcion_equipo' => 'Descripcion Equipo',
            'txt_serie_equipo' => 'Serie de Equipo',
            'txt_iccid' => 'ICCID',
            'txt_imei' => 'IMEI',
            'txt_telefono' => 'Telefono',
            'txt_clave_sim_card' => 'Clave de Sim Card',
            'txt_descripcion_sim' => 'Descripcion Sim',
            'txt_serie_sim_card' => 'Txt Serie Sim Card',
            'txt_nombre_completo_cliente' => 'Nombre Completo',
            'txt_numero_referencia' => 'Numero Referencia',
            'txt_numero_referencia_2' => 'Numero Referencia 2',
            'txt_numero_referencia_3' => 'Numero Referencia 3',
            'txt_calle_numero' => 'Calle de Numero',
            'txt_colonia' => 'Colonia',
            'txt_codigo_postal' => 'Codigo Postal',
            'txt_municipio' => 'Municipio',
            'txt_entre_calles' => 'Entre Calles',
            'txt_observaciones_punto_referencia' => 'Observaciones Punto Referencia',
            'txt_motivo_cancelacion' => 'Txt Motivo Cancelacion',
            'fch_cita' => 'Fecha Cita',
            'fch_hora_cita' => 'Hora Cita',
        ];
    }
