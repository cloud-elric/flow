...
role="navigation">
  <div class="navbar-header">
    ...
    <a class="navbar-brand navbar-brand-center" href="<?=Url::base()?>">
      ...
      <img class="navbar-brand-logo navbar-brand-logo-special" src="<?=Url::base()?>/webAssets/images/logo-plan-perfecto-bco.png"
			    title="Plan Perfecto Telcel">
    </a>
      ...
      <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" role="menu">
            <a class="dropdown-item" href="<?=Url::base()?>/profile" role="menuitem">
