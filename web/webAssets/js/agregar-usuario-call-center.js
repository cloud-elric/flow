...
var formUsuario = $("#form-guardar-usuario");
var botonEnviar = "btn-guardar-usuario";

formUsuario.on('beforeSubmit', function(e) {
    var form = $(this);
...
formUsuario.on('afterValidate', function (e, messages, errorAttributes) {
